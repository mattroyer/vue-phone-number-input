    ...
    computed: {
      ...
      theme () {
        return {
          ...
          boxShadowColor: { boxShadow: `0 0 0 0 ${getShadowColor(this.color)}` },
          boxShadowValid: { boxShadow: `0 0 0 0 ${getShadowColor(this.validColor)}` },
          boxShadowError: { boxShadow: `0 0 0 0 ${getShadowColor(this.errorColor)}` },
